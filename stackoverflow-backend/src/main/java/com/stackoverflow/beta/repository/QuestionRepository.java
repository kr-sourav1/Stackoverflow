...
public interface QuestionRepository extends JpaRepository<Question, Integer> {
    ...
    // Fetch top questions with answers and comments
//    @Query("SELECT DISTINCT q FROM Question q ORDER BY q.votes DESC")
//    List<Question> findTopQuestionsByVotes();
    @Query("SELECT q FROM Question q JOIN FETCH q.user u ORDER BY q.votes DESC")
    List<Question> findTopQuestionsByVotes(); // returns all; service will limit
}
